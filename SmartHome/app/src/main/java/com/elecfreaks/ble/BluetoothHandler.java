...
import com.elecfreaks.ui.DeviceDetail;
import com.elecfreaks.ui.MainActivity;
...
public class BluetoothHandler implements Serializable{
	...
	private OnValidBLEModuleListener onValidBLEModuleListener;
	private OnScanListener onScanListener;
	
	private List<BluetoothGattService> gattServices = null;

	public BluetoothGattService getTargetGattService() {
		return targetGattService;
	}

	private BluetoothGattService targetGattService = null;
	...
	public void setOnValidBLEModuleListener(OnValidBLEModuleListener l){
	...
	public void getCharacteristic(List<BluetoothGattService> gattServices){
		...
		if(readGattCharacteristic != null) {
			...
			if (onValidBLEModuleListener != null) {
				onValidBLEModuleListener.onValidBLEModule(true);
			}
		}
