...
import com.utd.tumblrr.datastore.RetainedFragment;
import com.utd.tumblrr.tasks.AsyncDashboardFetcher;
import com.utd.tumblrr.tasks.AsyncLoginTask;
import com.utd.tumblrr.ui.adapter.CustomAdapter;
...
public class DashBoardActivity extends AppCompatActivity
    ...
    private static final String RETAINED_FRAGMENT_TAG = "tumblrr";
    ...
    private void startDashboardFetchTask(Integer offset) {
        ...
        String token = "5AX3lj6EjPUVTbMOKvuMHBPb8M4NWZN5kerNXo4v7RYmzPKXCC";//sp.getString(getString(R.string.token), null);
        String secret = "KsvGQwzzuKM1fv7jMNdEhDqH1NwpJL7JB6AUoxxBEfweLKh6np";//sp.getString(getString(R.string.secret), null);

        //Log.d(TAG, "token: "+ token+ " secret: "+ secret);
        //Toast.makeText(this, "token: "+ token+ " secret: "+ secret, Toast.LENGTH_SHORT).show();
